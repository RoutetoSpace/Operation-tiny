...
void loop()
{
  ...
  Valout = (Vout/22.5)-64.11111111; //previous value was 61.11111 in line with formula from tech report.  Calibration against house themostat required 3 degrees less.
